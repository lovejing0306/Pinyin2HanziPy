...
SENTENCE_FILE     = '../data/train/result/sentence.txt'
WORD_FILE         = '../data/train/original/word.txt'
HANZI2PINYIN_FILE = '../data/train/original/hanzipinyin.txt'

BASE_START      = '../data/train/result/other_base_start.json'
BASE_EMISSION   = '../data/train/result/other_base_emission.json'
BASE_TRANSITION = '../data/train/result/other_base_transition.json'
